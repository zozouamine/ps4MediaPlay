...
CFLAGS      := --target=x86_64-pc-freebsd12-elf -fPIC -funwind-tables -c -O2 -std=c++17 -D_POSIX_C_SOURCE=200809L -Du_short="unsigned short" -Du_int="unsigned int" -DDT_DIR=4 -Iinclude -isysroot $(TOOLCHAIN) -isystem $(TOOLCHAIN)/include
